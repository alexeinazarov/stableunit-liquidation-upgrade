...
\]
where \( L \) is the liquidation loss random variable, and \( V \) is collateral value.\parencite{bcbs_marketrisk_2019}.\footnote{While formally defined by Basel III \parencite{bcbs_marketrisk_2019}, the application of VaR in DeFi is still evolving. Chainlink has proposed a percentile-based liquidation risk model \parencite{chainlink2025svr}, and LlamaRisk has independently applied it in the context of Aave's SVR integration proposal \parencite{llamarisk2025svrreview}, which remains under community review.}
