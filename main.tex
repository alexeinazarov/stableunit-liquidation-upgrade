...
\newtheorem{theorem}{Theorem}[section]  % Optional: [section] for numbering like 3.1, 3.2, etc.
\newtheorem{corollary}[theorem]{Corollary}  % Shares counter with theorem
\newtheorem{lemma}[theorem]{Lemma}

% Optional: Define proof environment (already included in amsthm)

\usepackage{minted} % Enables syntax highlighting for code
\usepackage{xcolor} % Required for minted to color syntax
\definecolor{codegray}{gray}{0.97} % Light gray background
%%%
