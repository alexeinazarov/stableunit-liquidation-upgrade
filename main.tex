...
\begin{enumerate}[label=\textbf{\arabic*.},wide, labelindent=0pt]
  ...
  \item \textbf{Dynamic Keeper Bounties} (\secref{sec:keeper}): replaces fixed 0.1\% liquidator fees with a diminishing-marginal payout curve \eqref{eq:bountyrate}, aligning incentives across vault sizes while capping micro-vault APRs.
